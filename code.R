...
rm(list=ls(all=T))
# read train data
machine_train <- read.csv(file.choose()) #read.csv("Train.csv")
machine_test <- read.csv(file.choose())#read.csv("Test.csv")
...
Train_AdditionalData <- read.csv(file.choose())# read.csv("Train_AdditionalData.csv")
Test_AdditionalData <- read.csv(file.choose())#read.csv("Test_AdditionalData.csv")
